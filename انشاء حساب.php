...
<head>
    ...
    <link rel="stylesheet" href="mysql_db.php">
</head>
<body>
...
<header>
    ...
    <aside class="aside-page">
        <form action="insert_data.php" method="post" onsubmit="return validatePassword()">
            ...
            <div class="form-group">
                <label for="gender">نوع الحساب:</label>
                <select id="gender" required>
                    <option value="">اختر</option>
    ...
    <div class="form-group">
                <button onclick="window.location.href='انشاء حساب لمركز تعليمي.php';">انشاء حساب لمركز تعليمي</button>
